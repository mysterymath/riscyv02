...
generate
  for (i = 0; i < 4; i++)
    mux #(16) r1_0(r_r[i], r_r[i+1], r1_num[0], r1_0_r[i]);
  for (i = 0; i < 2; i++)
    mux #(16) r1_1(r1_0_r[i], r1_0_r[i+1], r1_num[1], r1_1_r[i]);
  mux #(16) r1_2(r1_1_r[0], r1_1_r[1], r1_num[2], r1);
endgenerate;
...
generate
  for (i = 0; i < 4; i++)
    mux #(16) r2_0(r_r[i], r_r[i+1], r2_num[0], r2_0_r[i]);
  for (i = 0; i < 2; i++)
    mux #(16) r2_1(r2_0_r[i], r2_0_r[i+1], r2_num[1], r2_1_r[i]);
  mux #(16) r2_2(r2_1_r[0], r2_1_r[1], r2_num[2], r2);
endgenerate;
